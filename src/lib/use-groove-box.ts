...
export function useGrooveBox({
   ...
   *
   * La boîte à rythme démarrait quand son effet React s'exécutait, soit après le
   * premier accord, d'un écart qui changeait d'une lecture à l'autre. En partant
   * du même point, les deux tombent ensemble sur le premier temps.
   */
