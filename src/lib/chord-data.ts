...
export const GUITAR_CHORDS: StringChord[] = [
  ...
  { id: "gDb", name: "Db", full: "Db major", category: "major", fingers: [[1,1,1],[2,2,1],[3,1,1],[4,3,1],[5,4,1]], open: [], muted: [6], startFret: 1 },
  ...
  { id: "gBb", name: "Bb", full: "Bb major", category: "major", fingers: [[1,1,1],[2,3,1],[3,3,1],[5,1,1]], open: [4], muted: [6], startFret: 1 },
  { id: "gB", name: "B", full: "B major", category: "major", fingers: [[1,2,1],[3,4,1],[4,1,1],[5,2,1]], open: [2], muted: [6], startFret: 1 },
  // Mineurs
  { id: "gCm", name: "Cm", full: "C minor", category: "minor", fingers: [[1,3,1],[2,1,1],[4,1,1],[5,3,1]], open: [3], muted: [6], startFret: 1 },
  { id: "gDbm", name: "Dbm", full: "Db minor", category: "minor", fingers: [[2,2,1],[3,1,1],[4,2,1],[5,4,1]], open: [1], muted: [6], startFret: 1 },
  ...
  { id: "gBbm", name: "Bbm", full: "Bb minor", category: "minor", fingers: [[1,1,1],[2,2,1],[3,3,1],[4,3,1],[5,1,1]], open: [], muted: [6], startFret: 1 },
  { id: "gBm", name: "Bm", full: "B minor", category: "minor", fingers: [[1,2,1],[3,4,1],[5,2,1]], open: [2,4], muted: [6], startFret: 1 },
  // 7
  ...
  { id: "gAb7", name: "Ab7", full: "Ab dom7", category: "dom7", fingers: [[6,4,1],[5,3,1],[4,1,1],[3,1,1],[2,1,1],[1,2,1]], open: [], muted: [], startFret: 1 },
  { id: "gA7", name: "A7", full: "A dom7", category: "dom7", fingers: [[2,2,1],[4,2,1]], open: [1,3,5], muted: [6], startFret: 1 },
  { id: "gBb7", name: "Bb7", full: "Bb dom7", category: "dom7", fingers: [[1,1,1],[2,3,1],[3,1,1],[5,1,1]], open: [4], muted: [6], startFret: 1 },
  ...
  // Min7
  { id: "gCm7", name: "Cm7", full: "C min7", category: "min7", fingers: [[5,3,1],[4,1,1],[3,3,1],[2,1,1],[1,3,1]], open: [], muted: [6], startFret: 1 },
  { id: "gDbm7", name: "Dbm7", full: "Db min7", category: "min7", fingers: [[5,4,1],[4,2,1],[3,1,1]], open: [1,2], muted: [6], startFret: 1 },
  ...
  { id: "gAbm7", name: "Abm7", full: "Ab min7", category: "min7", fingers: [[1,2,1],[3,1,1],[4,1,1],[5,2,1],[6,4,1]], open: [2], muted: [], startFret: 1 },
  { id: "gAm7", name: "Am7", full: "A min7", category: "min7", fingers: [[2,1,1],[4,2,1]], open: [1,3,5], muted: [6], startFret: 1 },
  { id: "gBbm7", name: "Bbm7", full: "Bb min7", category: "min7", fingers: [[1,1,1],[2,2,1],[3,1,1],[4,3,1],[5,1,1]], open: [], muted: [6], startFret: 1 },
