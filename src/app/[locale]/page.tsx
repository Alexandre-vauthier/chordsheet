...
const FEATURES: { id: string; href?: string; icon: React.ReactNode }[] = [
  ...
  { id: 'detect', href: '/chord-detect', icon: <><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15a3 3 0 003-3V6a3 3 0 00-6 0v6a3 3 0 003 3z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 12a7 7 0 0014 0M12 19v3"/></> },
  ...
  { id: 'dictionary', href: '/chords', icon: <><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 15.803a7.5 7.5 0 0010.607 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13.5 10.5h-6"/></> },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="rounded-2xl border border-white/8 bg-white/4 p-7 flex flex-col gap-5">
              <div className="w-11 h-11 rounded-xl bg-white/8 flex items-center justify-center">
                <svg className="w-5 h-5 text-[var(--nav-text)]/60" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Professeurs */}
            <div className="rounded-2xl border border-amber-400/20 bg-amber-400/5 p-7 flex flex-col gap-5">
