// Types pour les cellules d'accords — tout multiple de 0.25 jusqu'à 4
// Chaque 0.25 = 1 colonne dans la grille de 16 colonnes
export type CellSpan = 0.25 | 0.5 | 0.75 | 1 | 1.25 | 1.5 | 1.75 | 2 | 2.25 | 2.5 | 2.75 | 3 | 3.25 | 3.5 | 3.75 | 4;
...
export const INSTRUMENTS = ['guitar', 'mandolin', 'banjo', 'ukulele', 'piano', 'bass', 'voice', 'percussion'] as const;
